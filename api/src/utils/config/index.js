...
const API_RECIPES_INFO = 'https://api.spoonacular.com/recipes/complexSearch' + '?apiKey=' + API_KEY + `&number=10&addRecipeInformation=true`; //https://api.spoonacular.com/recipes/complexSearch?apiKey=07a9cf8e55824b2ebcc60aaa3b93d787&addRecipeInformation=true
